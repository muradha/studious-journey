...
Partial Public Class DataSet1
    ...
    Partial Public Class ADMINDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddADMINRow(ByVal ID As String, ByVal NAMA As String, ByVal PASSWORD As String) As ADMINRow
            Dim rowADMINRow As ADMINRow = CType(Me.NewRow,ADMINRow)
            Dim columnValuesArray() As Object = New Object() {ID, NAMA, PASSWORD}
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class ADMINTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""C##SCOTT"".""ADMIN"" (""ID"", ""NAMA"", ""PASSWORD"") VALUES (:ID, :NAMA, :PA"& _ 
                "SSWORD)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""C##SCOTT"".""ADMIN"" SET ""ID"" = :ID, ""NAMA"" = :NAMA, ""PASSWORD"" = :PASSWORD "& _ 
                "WHERE ((""ID"" = :Original_ID) AND ((:IsNull_NAMA = 1 AND ""NAMA"" IS NULL) OR (""NAM"& _ 
                "A"" = :Original_NAMA)) AND ((:IsNull_PASSWORD = 1 AND ""PASSWORD"" IS NULL) OR (""PA"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, NAMA, PASSWORD FROM ""C##SCOTT"".ADMIN"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As String, ByVal Original_NAMA As String, ByVal Original_PASSWORD As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ID As String, ByVal NAMA As String, ByVal PASSWORD As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID As String, ByVal NAMA As String, ByVal PASSWORD As String, ByVal Original_ID As String, ByVal Original_NAMA As String, ByVal Original_PASSWORD As String) As Integer
            If (ID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ID")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal NAMA As String, ByVal PASSWORD As String, ByVal Original_ID As String, ByVal Original_NAMA As String, ByVal Original_PASSWORD As String) As Integer
            Return Me.Update(Original_ID, NAMA, PASSWORD, Original_ID, Original_NAMA, Original_PASSWORD)
        End Function
    End Class
